...
public class CityController {
    ...
    public CityController(LoggerService loggerService, MessageSource messageSource, CountryService countryService, CityService cityService, CommentService commentService) {
