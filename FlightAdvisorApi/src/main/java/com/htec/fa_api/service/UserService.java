...
public class UserService {
    ...
    public User insert(User object) throws HttpException {
        ...
        String text = "Username: ".concat(object.getUsername()).concat("\nYour password: ").concat(autoGeneratedPasswd);

        sender.sendEmail(object.getEmail(), messageSource.getMessage("mail.subject.addUser", null, null), text);
        log.info(messageSource.getMessage("mail.sent.addUser", null, null) + " for " + object);
